          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-center">
                <div className="flex-shrink-0 flex items-start justify-center left-0">
                  <img
              ...
              <a href="https://calendly.com/admitas/" className="inline-flex items-center bg-admit-red border-0 py-2 px-4 focus:outline-none hover:outline transition-b duration-500 hover:bg-admit-blue text-white rounded-full text-base font-bold mt-4 md:mt-0">Booking
      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-1 animate-pulse" viewBox="0 0 24 24">
